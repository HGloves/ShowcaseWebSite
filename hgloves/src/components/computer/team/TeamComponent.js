...
class TeamComponent extends Component {
    ...
    render() {
        ...
        return (
            <div className="TeamComponentContainer" id='team'>
                <div>
                    <ItemsCarousel
                            ...
                            return (
                                <div key={key} className='TeamCarouselCardContainer'>
                                    ...
                                    <div className='TeamCarouselContentContainer'>
                                        ...
                                        <Typography variant='h5' color='primary' style={{ fontWeight: 'bold', marginTop: '2%' }}>{this.computeAge(member.birthDate) + ' ans'}</Typography>
                                        <Typography variant='h5' color='primary' style={{ fontWeight: 'bold', marginTop: '2%' }}>{member.pole}</Typography>
                                        <div className='TeamCarouselSocialNetworkContainer'>
